			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" action="server.php">
					...
					<div class="wrap-input100 validate-input" data-validate="Enter Gender">
						<input class="input100" type="Radio" name="Gender" placeholder="Male" checked>Male
						<input class="input100" type="Radio" name="Gender" placeholder="Female" >Female
					...
					<div class="container-login100-form-btn">
						<button name='st_register' class="login100-form-btn">
							Register
						</button>
					</div>
